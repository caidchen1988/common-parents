	...
	public static Converter processArguments(String[] args) throws Exception{
		...
		try {
			...
			if(values.type == null){
				...
				switch(values.type){
				case DOC: converter = new Doc2PdfConverter(inStream, outStream, shouldShowMessages, true);
				break; 
				case DOCX: converter = new Docx2PdfConverter(inStream, outStream, shouldShowMessages, true);
				break;
				case PPT:  converter = new Ppt2PdfConverter(inStream, outStream, shouldShowMessages, true);
				break;
				case PPTX: converter = new Pptx2PdfConverter(inStream, outStream, shouldShowMessages, true);
				break;
				case ODT: converter = new Odt2PdfConverter(inStream, outStream, shouldShowMessages, true);
				break;
