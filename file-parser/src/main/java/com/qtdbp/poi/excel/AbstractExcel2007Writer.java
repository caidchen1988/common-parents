...
public abstract class AbstractExcel2007Writer {
     ...
     * @throws Exception
     */
    public void process(OutputStream out, ExcelSheetModel sheetModel) throws Exception{
        // 建立工作簿和电子表格对象
        XSSFWorkbook wb = new XSSFWorkbook();
...
//        out.close();
    ...
    public abstract void generate(ExcelSheetModel sheet) throws Exception;
    ...
    public static class SpreadsheetWriter {
        ...
        public void createCell(int columnIndex, String value, int styleIndex)
                throws IOException {
            String ref = new org.apache.poi.hssf.util.CellReference(_rownum, columnIndex)
                    .formatAsString();
