 ...
 *
 * @author: caidchen
 * @create: 2017-05-22 17:48
 * To change this template use File | Settings | File Templates.
 */
@Deprecated
public abstract class ExcelBigReader extends DefaultHandler {
...
//      System.out.println("endElement: " + localName + ", " + name);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String file = "C:\\Users\\dell\\Desktop\\物流(2)\\全国物流企业.xlsx";

        ExcelBigReader reader = new ExcelBigReader() {
