...
public class Doc {
         ...
         * @param in
         * doc file
         * Parameter modified to use generic InputStream instead of FileInputStream (By Yeo Kheng Meng)
        ...
        public static void main(String[] args) throws Exception {
                ...
                WordprocessingMLPackage out = convert(new FileInputStream("E://2003.doc"));

                 String outputfilepath = "E://testdocx.docx";
